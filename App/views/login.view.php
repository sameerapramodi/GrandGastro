						...
						<div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
							...
							<div class="d-flex justify-content-center py-4">
								<a href="index.html" class="logo d-flex align-items-center w-auto">
									<img src="<?= BASE ?>assets/img/logo1.png" alt=""><!--Logo -->
									<span class="d-none d-lg-block">Customer</span><!--login as customer -->
								</a> 
							</div><!-- End Logo -->
								...
								<div class="card-body">
									...
									<form class="row g-3 needs-validation" method="POST" novalidate>
										...
										<div class="col-12">
											...
											<input type="password" name="password" class="form-control" id="yourPassword" required> <!--validation of password-->
							...
							<div class="credits">
								Designed by <a href="">group 4</a><!--https://abc.com/-->
							</div>
